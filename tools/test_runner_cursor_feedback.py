...
class CursorFeedbackTests(unittest.TestCase):
    ...
    def test_invalid_or_incomplete_coordinate_reads_fail_closed(self):
        for raw,shift in ((b'bad',b'\0'),(bytes(8),b''),(bytes(8),b'\x16'),(bytes(8),b'\xff'),
    ...
    def test_observed_4k_fixed_point_cursor_uses_six_fractional_bits(self):
        for raw, point in (((64, 64), (1, 1)), ((140544, 78848), (2196, 1232))):
            self.assertEqual(tool.decode_cursor(struct.pack('<ii', *raw), b'\x06', (3840, 2160)), point)
