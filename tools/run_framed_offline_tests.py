...
SUITES = (
    ...
    "test_framed_modal_primary_text.PrimaryTextTests",
    "test_framed_modal_primary_text.PrimaryText800Tests",
    "test_framed_modal_primary_text.PrimaryText720Tests",
    "test_framed_modal_primary_text.PrimaryText960Tests",
    "test_framed_modal_primary_text.PrimaryText1080Tests",
    "test_framed_modal_primary_text.PrimaryTextFractionalTests",
    "test_pe_modal_primary_text_extension",
    "test_build_framed_modal_primary_text_candidate.PrimaryTextBoundaryTests",
    "test_build_framed_modal_primary_text_candidate.PrimaryTextProbeTests",
    "test_build_framed_modal_primary_text_candidate.PrimaryText800BuildTests",
    "test_build_framed_modal_primary_text_candidate.PrimaryText1024BuildTests",
    "test_build_framed_modal_primary_text_candidate.PrimaryText720BuildTests",
    ...
    "test_complete_hd_army_movement_capture",
    "test_complete_hd_army_movement_surface_audit",
