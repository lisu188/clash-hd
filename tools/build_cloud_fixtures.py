...
def default_entries() -> list[dict[str, Any]]:
    ...
    entries = [
        ...
        repo_json_key(
            "captures/current/hd-map-smoke-current.json",
        ...
        repo_file(
            "captures/current/post-owner-evidence-current.json",
        ...
        repo_file(
            "captures/current/patch-manifest-compare-current-vs-partial12.json",
