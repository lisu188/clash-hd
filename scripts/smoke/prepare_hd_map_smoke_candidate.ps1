param(
    ...
    [string]$NormalRun = 'captures\archive\cdb-surface-dump-20260506-190037',
    [string]$ForcedRun = 'captures\archive\cdb-surface-dump-20260506-201114',
    [string]$PatchManifest = 'captures\current\patch-stage-current-hd-map.json',
    [string]$MatrixJson = 'captures\current\hd-map-smoke-current.json',
    [string]$MatrixMarkdown = 'captures\current\hd-map-smoke-current.md',
    [switch]$Execute,
