...
- Log: `captures\cdb-surface-dump-20260527-165909\cdb-surface-dump.log`
- Proof class: `natural_slot5_right_bottom_route`
- Status: `owner_action_render_begin_stalled`
- Expected slot: `5`
- Selected arg: `5`
- Selected global: `5`
...
- Owner flag test: `{'owner': 69715738, 'owner_flag': 11, 'bit2': 2, 'bit1': 1, 'bit8': 8, 'ret': 4333600, 'd532150': 69715738, 'd53214c': 1, 'd532154': 167928080}`
- Owner/action route count: `1`
- Owner/action draw count: `0`
- Owner/action prelude count: `5`
- Owner/action Render_Begin reached: `True`
- Owner/action Render_Begin returned: `False`
- Owner/action Render_Begin stalled: `True`
- Castle hitmap sample: `{'surface': 171619416, 'size': [640, 480], 'base': 172163120, 'displayed': [231, 366], 'displayed_sample': 12, 'native': [151, 306], 'native_sample': 254, 'bbox_min': [77, 306], 'bbox_min_sample': 254, 'bbox_max': [237, 426], 'bbox_max_sample': 53, 'expected_raw': 254}`
...
- owner/action prelude markers were observed: 5
- owner/action prelude reached Render_Begin but no return row was observed
- owner/action route markers were observed
- owner/action draw rows were not observed after route entry

## Key Rows

- line 203: `SURFDUMP_PLAYGAME gd=04200030 map=(100,100) scroll=(11,17) surface=041fc940 size=(640,480)`
...
- line 205: `NOWNER_CASTLE_OVERVIEW_ENTRY ret=0041ed6f castle_index=0 main_surface=0a07ee10 size=(800,600) NOWNER_CASTLE_OVERVIEW_POST_DRAW overview_surface=0a3ab458 size=(640,480) owner_screen=0427c71a`
- line 205: `NOWNER_CASTLE_HITMAP_SAMPLE surface=0a3ab458 size=(640,480) base=0a430030 displayed=(231,366) displayed_sample=0x0c native=(151,306) native_sample=0xfe bbox_min=(77,306) bbox_min_sample=0xfe bbox_max=(237,426) bbox_max_sample=0x35 expected_raw=254`
...
- line 205: `NOWNER_OWNER_FLAG_TEST owner=0427c71a owner_flag=0x0b bit2=2 bit1=1 bit8=8 NOWNER_WRITE_532154 continue_full ret=00422020 d532150=0427c71a d53214c=00000001 d532154=0a026110 owner_flag=0x0b`
...
- line 205: `NOWNER_419ED0_ENTRY desc=00514ff5 ret=004338e6 state=1 sound=004efd67`
- line 205: `NOWNER_419ED0_SOUND_PREP desc=00514ff5 sound=004efd67 ret=004338e6`
- line 205: `NOWNER_419ED0_SOUND_RETURN desc=00514ff5 ret=004338e6 eax=004efd67`
- line 205: `NOWNER_419ED0_STATE6_READY desc=00514ff5 ret=004338e6 state=1 d544cd8=00544cd8`
- line 205: `NOWNER_419ED0_RENDER_BEGIN desc=00514ff5 ret=004338e6 d544d10=00000001 render=00000001 eax=00545198 ebx=00000000 ecx=0050f204 edx=00544cd8 esi=00544cd8 edi=00000003`
