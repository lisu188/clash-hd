...
- Log: `captures\archive\cdb-surface-dump-20260616-133855\cdb-surface-dump.log`
- PNG: `captures\archive\cdb-surface-dump-20260616-133855\surface.png`
- Expected slot: `0`
- Evidence pass: `False`
...
- Missing hover modes: `['action_box_hover', 'safe_center_hold']`
...
- Tooltip null-present rows by region: `{'frame_left': 0, 'frame_top': 0, 'right_frame_under_minimap': 5, 'bottom_tooltip': 5, 'bottom_right_panel': 5, 'bottom_frame': 5}`
...
## PNG Regions
- `selected_unit_action_bar`: nonblack `96.461%`, black `3.539%`, mean_luma `85.071`, rect `[150, 528, 520, 573]`
- `bottom_tooltip_strip`: nonblack `67.464%`, black `32.536%`, mean_luma `62.933`, rect `[32, 528, 585, 599]`
