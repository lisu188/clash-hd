...
- PNG: `captures\cdb-surface-dump-20260527-114559\surface.png`
- Expected slot: `0`
- Evidence pass: `True`
...
- selected-unit action-bar visual regression gate passed
...
## PNG Regions
- `selected_unit_action_bar`: nonblack `99.982%`, black `0.018%`, rect `[150, 455, 520, 500]`
