...
- PNG: `captures\archive\cdb-surface-dump-20260616-153751\surface.png`
- Expected slot: `0`
- Evidence pass: `False`
...
## PNG Regions
- `selected_unit_action_bar`: nonblack `91.954%`, black `8.046%`, mean_luma `66.995`, rect `[215, 580, 585, 599]`
- `bottom_tooltip_strip`: nonblack `73.406%`, black `26.594%`, mean_luma `70.503`, rect `[32, 528, 585, 599]`
