...
- Log: `captures\cdb-surface-dump-20260527-120522\cdb-surface-dump.log`
- Status: `no_main_load_handoff`
- Expected slot: `4`
- Target slot: `4`
- Target slot values: `[]`
- Target slot consistent: `True`
- Target slot expected match: `False`
- LOADSAVE slot match: `None`
- PlayGame slot match: `None`
- Expected slot match: `False`
- Rows parsed: `0`
- Access violations: `0`
...
- all observed target_slot values do not match expected slot 4
