...
- Overall: PASS
- Log: `captures\archive\cdb-surface-dump-20260616-153155\cdb-surface-dump.log`
- Ready seen: `True`
- AV free: `True`
- Unit selected: `True`
...
- Coverage JSON: `captures\archive\cdb-surface-dump-20260616-153155\map-tile-coverage-full.json`
- Visibility JSON: `captures\archive\cdb-surface-dump-20260616-153155\visibility-coverage-full.json`
- Blank active cells: `[]`
- Visibility unexplained blank cells: `[]`
- All blank cells visibility-explained: `False`
...
- Gameplay frame likely: `None`
- Flagged active cells: `None`
- Measurable active cells: `None`
- Visibility status counts: `{}`
