...
- Overall: PASS
- Generated: `2026-09-08T11:21:23+02:00`
...
- `scripts\smoke\run_clash_visual_smoke.ps1`: `PASS` guard_lines=`[71]` first_risky_line=`496` child_helper_lines=`[]`
- `scripts\smoke\run_hd_soak.ps1`: `PASS` guard_lines=`[1150]` first_risky_line=`1278` child_helper_lines=`[]`
...
- Root: `C:\Users\andrz\.codex\worktrees\7d0c\clash-hd`
- Risky scripts: `0`
