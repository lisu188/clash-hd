...
- `scripts\smoke\run_clash_visual_smoke.ps1`: `PASS` guard_lines=`[66]` first_risky_line=`491` child_helper_lines=`[]`
- `scripts\smoke\run_hd_soak.ps1`: `PASS` guard_lines=`[1165]` first_risky_line=`1293` child_helper_lines=`[]`
