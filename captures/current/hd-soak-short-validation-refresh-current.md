...
- Overall: PASS
- Generated: `2026-06-15T20:14:55.918572+00:00`
...
- Guards written: `0`
- Triage written: `0`
- Failed runtime reports classified: `0`

## Steps

- `short2_menu_idle`: status=`no_report` report_exists=`False` guard=`False` triage=`False`
- `short2_map_idle`: status=`no_report` report_exists=`False` guard=`False` triage=`False`
