...
- Scanned CDB logs: `27`
- Relevant runs: `13`
- Classification counts: `{'forced_owner_action_route': 7, 'natural_state_gated': 1, 'natural_ui_descriptor_only': 1, 'non_natural_isolated_fixture': 4}`
...
- `natural_ui_descriptor_only`: `captures/archive/cdb-surface-dump-20260712-193922` stage `None` classifications `['natural_ui_descriptor_only']`
...
- `captures/archive/cdb-surface-dump-20260712-193922`: `['natural_ui_descriptor_only']`, forced `[]`, actions `[]`, owner-render `[]`
