...
- Non-natural isolated fixture routes: `5`
- Non-natural fixture owner/action rows: `18`
...
- `natural_ui_descriptor_only`: `captures/archive/cdb-surface-dump-20260714-141021` stage `gameplay-menu640-centered-map12-dynorigin-mapsurface-scrollclamp-presentbounds-minimapright-dynvswitch-rightbottomcompose` classifications `['natural_ui_descriptor_only']`
...
- `captures/archive/cdb-surface-dump-20260714-141021`: `['natural_ui_descriptor_only']`, forced `[]`, actions `[]`, owner-render `[]`
- `captures/archive/cdb-surface-dump-20260714-145855`: `['non_natural_isolated_fixture']`, forced `[]`, actions `[]`, owner-render `['NOWNER']`
