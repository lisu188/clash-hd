...
- Overall: PASS
- Generated: `2026-09-06T03:57:57.701641+00:00`
...
- Source report: `captures\current\hd-soak-short10-map-pan-current.json`
...
- Failure timestamp: `2026-09-05T10:11:12.7268029+02:00` source=`last_process_sample`
...
- Last frame: `frame-0041` size=`800x600` nonblack=`97.34` luma=`None` colors=`164`
- Last process: exited=`False` exit_code=`None` working_set=`37289984` handles=`607`

## Metrics

- `frame_sample_count`: `41`
- `frame_hash_unique_count`: `41`
...
- `working_set_growth_bytes`: `200704`
- `private_memory_growth_bytes`: `208896`
- `handle_growth`: `-6`
- `artifact_bytes`: `3896428`
