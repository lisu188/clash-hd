...
- Guard policy: proves the manual DirectInput proof template documents the proof shape, stays invalid until placeholders are replaced, and can become valid only after all required manual proof fields are supplied
