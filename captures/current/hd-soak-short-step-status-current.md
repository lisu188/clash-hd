...
- Overall: PASS
- Generated: `2026-07-18T08:58:23.410081+00:00`
...
- Current step: `short2_map_idle` status=`failed_classified_input_environment_permission_denied`
- Passed steps: `1/5`
...
- `short2_map_idle`: tier=`short2` route=`map-idle` status=`failed_classified_input_environment_permission_denied` passed=`False`
