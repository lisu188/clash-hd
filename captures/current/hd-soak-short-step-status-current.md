...
- Overall: PASS
- Generated: `2026-07-18T19:36:45.120314+00:00`
...
- `short2_map_idle`: tier=`short2` route=`map-idle` status=`failed_classified_window_missing_while_process_alive` passed=`False`
