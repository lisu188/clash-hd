...
- Overall: PASS
- Generated: `2026-07-18T08:18:22.578841+00:00`
...
- `short2_map_idle`: tier=`short2` route=`map-idle` status=`failed_classified_intro_skip_input_drift_exit` passed=`False`
