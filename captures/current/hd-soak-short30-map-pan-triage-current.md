...
- Overall: PASS
- Generated: `2026-09-06T03:57:57.715644+00:00`
...
- Failure timestamp: `2026-09-05T11:38:30.6345701+02:00` source=`last_process_sample`
...
- Last frame: `frame-0119` size=`800x600` nonblack=`97.341` luma=`None` colors=`200`
- Last process: exited=`False` exit_code=`None` working_set=`37425152` handles=`613`

## Metrics

- `frame_sample_count`: `119`
- `frame_hash_unique_count`: `119`
- `frame_progress_expected`: `True`
- `frame_stability_class`: `progressing`
- `nonblack_percent_min`: `97.339`
- `nonblack_percent_max`: `97.341`
- `mean_luma_min`: `None`
- `mean_luma_max`: `None`
- `unique_sample_colors_min`: `197`
- `unique_sample_colors_max`: `206`
- `input_max_abs_error`: `None`
- `input_max_sample_abs_error`: `None`
- `max_input_drift_px`: `None`
- `process_sample_count`: `119`
- `working_set_growth_bytes`: `192512`
- `private_memory_growth_bytes`: `0`
- `handle_growth`: `-10`
- `artifact_bytes`: `4084869`
