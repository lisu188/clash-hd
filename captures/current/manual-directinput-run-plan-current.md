...
- Overall: PASS
- Generated: `2026-06-15T20:47:20+02:00`
...
- Candidate placeholder: `<stable-hd-map-candidate-exe>`
- Route: `load-slot0`
...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File 'scripts\smoke\run_clash_visual_smoke.ps1' -Exe '<stable-hd-map-candidate-exe>' -WorkDir 'C:\Clash' -Route 'load-slot0' -Points '300,218;320,166;400,226' -MoveMode auto -ClickMode sendinput -ClickHoldMs 300 -ClickRepeat 2 -AllowVisibleRuntime
```
...
- Candidate placeholder: `<rightbottomcompose-candidate-exe>`
- Route: `load-slot0`
- Load-route points: `300,218;320,166;400,226`
...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File 'scripts\smoke\run_clash_visual_smoke.ps1' -Exe '<rightbottomcompose-candidate-exe>' -WorkDir 'C:\Clash' -Route 'load-slot0' -Points '300,218;320,166;400,226' -MoveMode auto -ClickMode sendinput -ClickHoldMs 300 -ClickRepeat 2 -AllowVisibleRuntime
```
...
- Candidate placeholder: `<castlecenter-all-candidate-exe>`
- Route: `load-slot0`
- Load-route points: `300,218;320,166;400,226`
...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File 'scripts\smoke\run_clash_visual_smoke.ps1' -Exe '<castlecenter-all-candidate-exe>' -WorkDir 'C:\Clash' -Route 'load-slot0' -Points '300,218;320,166;400,226' -MoveMode auto -ClickMode sendinput -ClickHoldMs 300 -ClickRepeat 2 -AllowVisibleRuntime
```
