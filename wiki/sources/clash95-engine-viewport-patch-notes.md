...
type: source-summary
source_path: CLASH95_ENGINE_VIEWPORT_PATCH_NOTES.md
...
- Source: `[source: CLASH95_ENGINE_VIEWPORT_PATCH_NOTES.md]`
...
- The current 800x600 HD map work is centered on the stage
  ...
  proof. [source: CLASH95_ENGINE_VIEWPORT_PATCH_NOTES.md]
